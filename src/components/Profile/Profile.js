    ...
    return (
        <div className="profile">
            ...
            >
                ...
                {editIsSuccess && <p className="profile__form-submit-success">Данные успешно изменены!</p>}
                {editIsFailed && <p className="profile__form-submit-failed">Ошибка при изменении данных</p>}
